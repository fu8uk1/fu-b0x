...
echo -e "Termux API" | lolcat;
echo -e "============================" | lolcat
echo -e $b "252. Install Admin_Panel_Finder${enda}"
echo -e "admin panel finder" | lolcat;
echo -e "============================" | lolcat
...
echo -e "SS7 MAP pentesting toolkit" | lolcat;
echo -e "============================" | lolcat
...
echo -e "${y} Installer virus mematikan"
echo -e "${y} cd android-malware"
echo -e "${y} ls"
echo -e "${y} Well you guys just went into the dictiory virus"
echo -e "${y} Contoh = cd xbot"
echo -e "${y} ls"
echo -e "${y} Well you just move the virus to sdcard"
